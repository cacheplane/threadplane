...
describe('React migration baseline scope', () => {
  ...
  for (const file of [
    ...
    'fixtures/react-parity/langgraph-candidate/runtime-entry.ts',
    'fixtures/react-parity/langgraph-candidate/installed-types.ts',
    'fixtures/react-parity/runtime/tools.ts',
    ...
    'libs/ag-ui/vite.runtime.config.mts',
    'libs/ag-ui/tsconfig.runtime-tests.json',
    'libs/ag-ui/src/runtime/create-http-request.ts',
    'libs/ag-ui/src/runtime/create-http-request.spec.ts',
