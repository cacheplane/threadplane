...
export const DEFAULT_SCOPE = {
  libraries: ['a2ui', 'ag-ui', 'chat', 'cockpit-registry', 'cockpit-runtime-bridge', 'cockpit-shell', 'cockpit-telemetry', 'design-tokens', 'e2e-harness', 'example-layouts', 'langgraph', 'middleware', 'render', 'telemetry', 'ui-react', 'workspace-react'],
